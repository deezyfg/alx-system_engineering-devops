# API Advanced
This project focuses on mastering the consumption of RESTful APIs using advanced techniques in Python. It encompasses scripting and back-end development, providing hands-on experience with various API interactions. Participants will enhance their skills by learning how to efficiently retrieve, manipulate, and utilize data from APIs, ensuring robust and scalable integration into applications.
...
* You must use the Requests module for sending HTTP requests to the [Reddit API](https://www.reddit.com/dev/api/)
